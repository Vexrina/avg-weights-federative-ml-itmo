...
type AddMyWeightsRequest struct {
	...
	// torch.save output (delta с глобальными весами!)
...
type GetReleaseWeightsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LinkToMinio   string                 `protobuf:"bytes,1,opt,name=link_to_minio,json=linkToMinio,proto3" json:"link_to_minio,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_serverside_proto_rawDesc = "" +
	...
	"\x18GetReleaseWeightsRequest\"?\n" +
	"\x19GetReleaseWeightsResponse\x12\"\n" +
	"\rlink_to_minio\x18\x01 \x01(\tR\vlinkToMinio2\xc5\x01\n" +
	"\n" +
	"AvgWeights\x12S\n" +
